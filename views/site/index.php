...
<html>
    <head>
        ...
        <link type="text/css" href="/template/css/price-range.css" rel="stylesheet">
        <link type="text/css" href="/template/css/animate.css" rel="stylesheet">
        <link type="text/css" href="/template/css/main.css" rel="stylesheet">
        <link type="text/css" href="/template/css/responsive.css" rel="stylesheet">
        <!--[if lt IE 9]>
